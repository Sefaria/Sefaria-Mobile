...
const Dedication = function(props) {
  ...
  return <View style={theme.menu}>
    ...
    <ScrollView>
      <Text style={[dStyles.welcome, {flexDirection: flexDirection}, theme.text]}>{isHeb ? 'האפליקציה של ספריא עבור אנדרואיד ו-iOS' : 'Sefaria App for iOS and Android'}</Text>
      <Text style={[dStyles.dedication, {flexDirection: flexDirection}, theme.text]}>{isHeb ? "מוקדש " +
        "לכבודם של הנרי וג'וליה קושיצקי ע''י ילדיהם" : 'Dedicated in honor of Henry and Julia Koschitzky ' +
        'by their children'}</Text>
      <Text style={[dStyles.simple, {flexDirection}, theme.text]}>{isHeb ? "בהשראת הערכים של צדקה וחובה קהילתי," +
      ...
      <Text style={[dStyles.simple, {flexDirection: flexDirection}, theme.text]}>{isHeb ? "האפליקציות מנגישות את העושר של הספרייה הדיגיטלית וחינמית שלנו " +
      ...
      <Text style={[dStyles.simple, {flexDirection: flexDirection}, theme.text]}>{isHeb ? "אנו אסירי תודה להנרי ולג'וליה לא רק עבור המנהיגות ודוגמא אישית שלהם, אלא גם לכל בני משפחת קושיצקי עבור הרעות המתמשכת ביננו. משפחת קושיצקי הייתה אחת התורמים הראשוניים שלנו, ומתכבדים לעבוד איתם שוב כדי להשיק את האפליקציות."
      ...
      <Text style={[dStyles.quote, theme.text]}>יגיע כפיך כי תאכל אשריך וטוב לך</Text>
      <Text style={[dStyles.quote, theme.text]}>(תהילים קכ"ח)</Text>
    </ScrollView>
  </View>
};
