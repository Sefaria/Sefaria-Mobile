...
export class MenuItemsMeta{
  static _items = [
    ...
    {title: 'signup', icon: 'profile-nav', loggedIn: false, ButtonComponent: SefariaTextAccountNavigationMenuButton, actionProps:{action: "menu", pushHistory: false,  destination:"register"}} , 
