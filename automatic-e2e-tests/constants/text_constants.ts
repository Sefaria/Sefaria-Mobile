...
export const BAMIDBAR_1 = {
    en: "On the first day of the second month, in the second year after the exodus from the land of Egypt, GOD spoke to Moses in the wilderness of Sinai, in the Tent of Meeting, saying:",
