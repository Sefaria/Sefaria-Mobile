...
let strings = new LocalizedStrings({
  en: {
    ...
    topics: "Topics",
    sources: "Sources",
    worksOnSefaria: "Works on Sefaria",
    ...
    ssoErrorGeneric: "Something went wrong. Try again.",
    ssoEmailExistsGoogle: "This email address is already registered via Google Sign-In.",
    ssoEmailExistsApple: "This email address is already registered via Apple Sign-In.",
  ...
  he: {
    ...
    topics: "נושאים",
    sources: "מקורות",
    worksOnSefaria: "חיבורים וכתבים בספריא",
    bilingual: "דו-לשוני",
    ...
    ssoErrorGeneric: "יש תקלה. נסו שוב.",
    ssoEmailExistsGoogle: "דוא״ל זה כבר רשום דרך גוגל.",
    ssoEmailExistsApple: "דוא״ל זה כבר רשום דרך אפל.",
