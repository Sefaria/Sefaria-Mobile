...
let strings = new LocalizedStrings({
  en: {
    ...
    failedToOpenURLMessage: "Failed to open ${uri}. If your browser is updating, wait for it to finish and try again. Otherwise, your phone might not have a browser installed. For help, email hello@sefaria.org.",
    doubleDownload: "Another Download is in Progress",
    downloadBlockedByNetwork: "Download Blocked by Network",
    networkSettingForbidsDownload: "Current network setting forbids download",
    networkSettingForbidsDownloadExtended: "Current network setting forbids download. Please change settings or connect to internet and try again.",
    wifiOnly: "Wi-Fi Only",
    ...
    debugNoLibraryMode: "Debug No Offline Library Mode",
    debugNoLibraryModeMessage: "You've just ${status} debugging without the offline library. You can change this by tapping 'System' 7 times.",
    enabled: "enabled",
    disabled: "disabled",
  },
  he: {
    ...
    promptOpenOnWebMessage: "הטקסט הזה אינו זמין כרגע באפליקציה, האם תרצו לפתוח אותו באתר האינטרנט?",
    noInternet: "חיבור רשת אינו זמין",
    noInternetMessage: "אנא בדקו את מצב החיבור שלכם ונסו שוב",
    ...
    define: "הגדרה",
    failedToOpenURL: "בפתיחת הקישור נכשלה",
    failedToOpenURLMessage: "פתיחת הקישור ${uri} נכשלה. אם הדפדפן שלך מתעדכן, המתן להשלמת העדכון ונסה שנית. אחרת, ייתכן שלמכשירך אין דפדפן מותקן. לעזרה, שלח דואר\"ל ל-hello@sefaria.org.",
    doubleDownload: "מוריד אוסף אחר, נא להמתין",
    downloadBlockedByNetwork: "ההורדה נחסמה על ידי הרשת",
    networkSettingForbidsDownload: "הגדרת הרשת הנוכחית אוסרת על הורדה",
    networkSettingForbidsDownloadExtended: "הגדרת הרשת הנוכחית אוסרת על הורדה. אנא שנה את ההגדרות או התחבר לאינטרנט ונסה שוב.",
    wifiOnly: "Wi-Fi בלבד",
    ...
    buyInPrint: 'קנה בדפוס',
    debugNoLibraryMode: "מצב דיבוג ללא ספרייה מקומית",
    debugNoLibraryModeMessage: "${status} מצב דיבוג ללא ספרייה מקומית. ניתן לשנות זאת על ידי לחיצה על 'מערכת' 7 פעמים.",
    enabled: "הפעלת",
    disabled: "ביטלת",
  }
});
