...
let strings = new LocalizedStrings({
  en: {
    ...
    ssoEmailExistsGoogle: "This email address is registered via Google Sign-In.",
  ...
  he: {
    ...
    authErrorNetwork: "יש בעיה ברשת. נסו לבדוק את החיבור לאינטרנט.",
    ssoEmailExistsGoogle: "דוא״ל זה רשום דרך גוגל.",
