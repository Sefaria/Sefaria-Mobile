...
let strings = new LocalizedStrings({
  en: {
    ...
    about: "About",
    feedback: "Feedback",
    dedicatedIOS: "Dedicated in honor of Henry Koschitzky by his children",
    dedicatedAndroid: "Dedicated in honor of Julia Koschitzky by her loving husband and children",
    cancel: "Cancel",
    open: "Open",
    tryAgain: "Try Again",
    ok: "OK",
  ...
  he: {
    ...
    about: "אודות",
    feedback: "משוב",
    dedicatedIOS: "נתרם לכבודו של הנרי קושיצקי על ידי ילדיו",
    dedicatedAndroid: "נתרם לכבודה של יוליה קושיצקי על ידי בעלה וילדיה האוהבים",
    cancel: "בטל",
    open: "פתח",
    tryAgain: "נסה שוב",
    ok: "אישור",
