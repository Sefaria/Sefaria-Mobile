...
const TextSegment = ({
  ...
  const style = textType == "hebrew" ?
                [styles.hebrewText, theme.text, justifyStyle, {fontSize, lineHeight: fontSize * lineHeightMultiplierHe}] :
                [styles.englishText, theme.text, justifyStyle, {fontSize: 0.8 * fontSize, lineHeight: fontSize * 1.04 }];
